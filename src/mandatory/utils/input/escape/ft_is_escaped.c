...
/*   Updated: 2025/11/24 17:54:24 by adriescr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * ENGLISH: Checks if the character at the given index in the string
 *          is escaped by a backslash.
 *
 * SPANISH: Verifica si el carácter en el índice dado en la cadena
 *          está escapado por una barra invertida.
 *
